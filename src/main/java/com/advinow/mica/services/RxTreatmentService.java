 ...
 *
 */
public interface RxTreatmentService {
	...
	TreatmentMainModel getAllIllnessTreatments(String icd10Code);

	List<TreatmentMainModel> getAllSymptomTreatments(String symptomID);
}
